@props(['label', 'required', 'value' => '', 'name', 'id' => null])
    ...
    <textarea
        ...
        {{ $attributes->merge([
            'class' =>
                ...
                ' dark:bg-gray-700 dark:text-gray-300 dark:focus:shadow-outline-gray form-textarea',
            'rows' => 3,
        ]) }}
        placeholder="{{ $placeholder ?? ($label ?? '') }}">{{ old($name, $value) }}</textarea>
